...
const { parentCategory, create, view, details, update, changeStatus, destroy } = require('../../controllers/admin/subCategory.controller');
...
module.exports = server => {
    ...
    server.use('/api/admin/sub-category', route);
}