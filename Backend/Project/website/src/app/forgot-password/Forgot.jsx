            ...
            <div>
                <div className='text-center mt-5 p-10 border-t-1 border-gray-200'>
                    ...
                    <div className='flex justify-center pt-3 items-center gap-2'>
                        ...
                        <p className='text-yellow-600'>Forgot Password</p>
                    </div>
                </div>
                ...
                <div className="flex  px-6 py-16 border-b-1 border-gray-200">
                    <div className="w-full ml-20 mr-20 grid grid-cols-1 md:grid-cols-1 gap-12">
                        <div>
                            ...
                            <h2 className="text-3xl text-gray-900 mb-6">Forgot Password</h2>
                            <div className="bg-white border border-gray-200 p-8">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button className="bg-[#b5845a] hover:bg-[black] text-white text-sm font-medium  px-6 py-2.5 rounded-full" disabled={ isLoading ? 'disabled' : '' }>
                                        {
                                            isLoading
                                            ?
                                            'Loading ....'
