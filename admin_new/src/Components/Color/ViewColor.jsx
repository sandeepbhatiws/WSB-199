      ...
      <section className="w-full">
        ...
        <nav className="flex border-b-2 bg-white py-3 px-6" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-2">
            ...
            <li>/ <a className="text-md font-medium text-gray-700 hover:text-blue-600">Color</a></li>
            <li>/ <span className="text-md font-medium text-gray-500">View Color</span></li>
          </ol>
        </nav>
        ...
        >
          ...
          <form
            ...
            className="p-3 relative my-3 rounded-lg border w-full bg-white shadow-sm"
          >
            {/* Close Button */}
            <button
              type="button"
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="mb-5">
                <label className="block mb-2 font-medium">Color Code</label>
                <input
                  type="text"
                  name="code"
                  autoComplete="off"
